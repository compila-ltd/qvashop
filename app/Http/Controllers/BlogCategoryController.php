...
class BlogCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('blog-category.index')->with('success', translate('Blog category has been created successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('blog-category.index')->with('success', translate('Blog category has been updated successfully'));
    }
