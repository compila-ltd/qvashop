            ...
            <div class="row">
                        ...
                        <div class="col order-1 order-md-2">
                            <div class="aiz-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true'>
                                ...
                                <div class="carousel-box img-zoom rounded">
                                    <img class="img-fluid lazyload" src="{{ asset('assets/img/placeholder.jpg') }}" data-src="{{ uploaded_asset($photo) }}">
                                </div>
                                @endforeach
                                @foreach ($detailedProduct->stocks as $key => $stock)
                                @if ($stock->image != null)
                                <div class="carousel-box img-zoom rounded">
                                    <img class="img-fluid lazyload" src="{{ asset('assets/img/placeholder.jpg') }}" data-src="{{ uploaded_asset($stock->image) }}">
                                </div>
                                @endif
                                @endforeach
                            </div>
                        ...
                        <div class="col-12 col-md-auto w-md-80px order-2 order-md-1 mt-3 mt-md-0">
                            <div class="aiz-carousel product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-vertical-sm='false' data-focus-select='true' data-arrows='true'>
                                ...
                                <div class="carousel-box c-pointer border p-1 rounded">
                                    <img class="lazyload mw-100 size-50px mx-auto" src="{{ asset('assets/img/placeholder.jpg') }}" data-src="{{ uploaded_asset($photo) }}">
                                </div>
                                @endforeach
                                @foreach ($detailedProduct->stocks as $key => $stock)
                                @if ($stock->image != null)
                                <div class="carousel-box c-pointer border p-1 rounded" data-variation="{{ $stock->variant }}">
                                    <img class="lazyload mw-100 size-50px mx-auto" src="{{ asset('assets/img/placeholder.jpg') }}" data-src="{{ uploaded_asset($stock->image) }}">
                                </div>
                                @endif
                                @endforeach
                            </div>
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="text-left">
                        ...
                        <p>
                            <a class="" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Ver puntos de recogida (almacén) y costos de envío a domicilio de {{ $shop_name }}</a>
                        </p>         
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="card card-body">
                                    @php 
                                        ...
                                        $pickup_points = \App\Models\PickupPoint::where('shop_id', $shop_id)
                                                        ->where('pick_up_status', 1)
                                                        ->get();
                                    ...
                                    <table class="table aiz-table mb-0">
                                        <thead>
                                            <tr>
                                                <th width="1%">#</th>
                                                <th width="20%">{{ translate('Name')}} almacén</th>
                                            ...
                                            @if(count($pickup_points)>0)               
                                                @foreach($pickup_points as $key => $point)
                                                    <tr>
                                                        ...
                                                        <td>{{ $point->name }}</td>
                                                        <td>{{ $point->address }}</td>
                                                        <td class="text-center">{{ $point->phone }}</td>
                                                    </tr>
                                                @endforeach
                                            @else
                                                <tr>
                                    ...
                                    <table class="table aiz-table mb-0">
                                        ...
                                        <tbody>
                                            @if(count($cities_for_delivery) > 0)                       
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="100%" class="text-center">Esta tienda no realiza envíos a domicilio</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
    ...
    <div class="container">
        <div class="row gutters-10">
                                ...
                                <div class="row gutters-10 align-items-center">
                                    <div class="col-5">
                                        <a href="{{ route('product', $top_product->slug) }}" class="d-block text-reset">
                                            <img class="img-fit lazyload h-xxl-110px h-xl-80px h-120px" src="{{ asset('assets/img/placeholder.jpg') }}" data-src="{{ uploaded_asset($top_product->thumbnail_img) }}" alt="{{ $top_product->getTranslation('name') }}">
                                        </a>
                                    </div>
            ...
            <div class="bg-white rounded shadow-sm mt-3">
                ...
                @guest
                <p class="fs-14 fw-400 mb-0 ml-3 mt-2"><a href="{{ route('user.login') }}">{{ translate('Login') }}</a> or <a class="mr-1" href="{{ route('user.registration') }}">{{ translate('Register ') }}</a>{{ translate(' to submit your questions to seller') }}
                </p>
                @endguest
                @auth
                <div class="query form p-3">
                    ...
                    <form action="{{ route('product-queries.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="3" cols="40" name="question" placeholder="{{ translate('Write your question here...') }}" style="resize: none;"></textarea>
