    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-3 col-md-6 w-full">
                <a class="text-reset border-left border-right text-center p-4 d-block" href="{{ route('terms') }}">
            ...
            -->
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left border-right text-center p-4 d-block" href="{{ route('supportpolicy') }}">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                ...
                <ul class="list-inline my-3 my-md-0 social colored text-center">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ get_setting('telegram_link') }}" target="_blank" class="telegram"><i class="lab la-telegram"></i></a>
                    </li>
                    @endif
                </ul>
                @endif
