...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h5 class="mb-0 h6">{{ translate('Add New') }}</h5>
    </div>
    <div class="">
        <form class="form form-horizontal mar-top" action="{{route('payment_method.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="short_name" placeholder="{{ translate('Short Name') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" id="currency">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" name="currency_id" id="currency_id" data-live-search="true" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="exchange_rate" placeholder="{{ translate('Exchange rate') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="automatic" value="1" checked> 
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="btn-group mr-2" role="group" aria-label="Third group">
                                    <button type="submit" class="btn btn-primary action-btn">{{ translate('Save') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
