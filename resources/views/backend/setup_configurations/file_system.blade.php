    ...
    <div class="col-xxl-6">
        <div class="card">
            <div class="card-header">
                <h3 class="fs-18 mb-0 text-center">{{ translate('DO File System Credentials') }}</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    @csrf
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="DO_ACCESS_KEY_ID">
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('DO_ACCESS_KEY_ID') }}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="DO_ACCESS_KEY_ID" value="{{  env('DO_ACCESS_KEY_ID') }}" placeholder="{{ translate('DO_ACCESS_KEY_ID') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="DO_SECRET_ACCESS_KEY">
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('DO_SECRET_ACCESS_KEY') }}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="DO_SECRET_ACCESS_KEY" value="{{  env('DO_SECRET_ACCESS_KEY') }}" placeholder="{{ translate('DO_SECRET_ACCESS_KEY') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="DO_DEFAULT_REGION">
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('DO_DEFAULT_REGION') }}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="DO_DEFAULT_REGION" value="{{  env('DO_DEFAULT_REGION') }}" placeholder="{{ translate('DO_DEFAULT_REGION') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="DO_BUCKET">
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('DO_BUCKET') }}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="DO_BUCKET" value="{{  env('DO_BUCKET') }}" placeholder="{{ translate('DO_BUCKET') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="DO_URL">
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('DO_URL') }}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="DO_URL" value="{{  env('DO_URL') }}" placeholder="{{ translate('DO_URL') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="DO_ENDPOINT">
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('DO_ENDPOINT') }}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="DO_ENDPOINT" value="{{  env('DO_ENDPOINT') }}" placeholder="{{ translate('DO_ENDPOINT') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
