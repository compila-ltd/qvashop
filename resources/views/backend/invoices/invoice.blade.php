					        ...
					        <table class="text-right sm-padding small strong">
						        <tbody>
							        <tr>
							            ...
							            <td class="currency">{{ single_price($order->orderDetails->sum('price') * $order->exchange_rate) }}</td>
							        </tr>
							        <tr>
							            <th class="gry-color text-left">{{ translate('Shipping Cost') }}</th>
							            <td class="currency">{{ single_price($order->orderDetails->max('shipping_cost') * $order->exchange_rate) }}</td>
							        </tr>
							        <tr class="border-bottom">
							            <th class="gry-color text-left">{{ translate('Total Tax') }}</th>
							            <td class="currency">{{ single_price($order->orderDetails->sum('tax') * $order->exchange_rate) }}</td>
							        </tr>
				                    <tr class="border-bottom">
							            <th class="gry-color text-left">{{ translate('Coupon Discount') }}</th>
							            <td class="currency">{{ $order->coupon_discount * $order->exchange_rate}}</td>
							        </tr>
							        <tr>
							            <th class="text-left strong">{{ translate('Total') }}</th>
							            <td class="currency">{{ single_price($order->grand_total * $order->exchange_rate) }}</td>
							        </tr>
						        </tbody>
						    </table>
			            </td>
