                ...
                <tr>
                    ...
                    <td>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input type="checkbox" @can('publish_blog') onchange="change_status(this)" @endcan value="{{ $blog->id }}" <?php if ($blog->status == 1) echo "checked"; ?> @cannot('publish_blog') disabled @endcan>
                            <span></span>
                        </label>
                    </td>
                    <td class="text-right">
