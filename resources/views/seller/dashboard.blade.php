        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card h-450px mb-0 h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('seller.orders.index') }}" class="order_status">
                        <div class="row align-items-center mb-4">
                                    ...
                                    <g id="Group_23742" data-name="Group 23742" transform="translate(2044 3467)">
                                        ...
                                        <g id="Group_23741" data-name="Group 23741" transform="translate(310 759)">
                                            <path id="Path_26908" data-name="Path 26908"
                                                ...
                                                transform="translate(-2351 -4226)" fill="#007bff" />
                                            <path id="Path_26909" data-name="Path 26909"
                                                ...
                                                transform="translate(-2491.298 -4498.774)" fill="#007bff" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            ...
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-13 fw-600" style="color: #007bff">{{ translate('New Order') }}</span>
                                </p>
                                <h3 class="mb-0" style="color: #007bff">
                                    {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'pending')->where('payment_status', 'paid')->count() }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('seller.orders.index') }}" class="order_status">
                        <div class="row align-items-center mb-4">
                            <div class="col-auto text-left">
                                <svg class="svg-icon" width="30" height="30" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M359.850667 726.016c22.058667-23.466667 105.045333-93.141333 106.112-94.037333a46.293333 46.293333 0 0 1 60.074666 0c1.066667 0.896 84.053333 70.570667 106.112 94.037333l0.725334 0.768a24.533333 24.533333 0 0 1-18.133334 41.216H377.258667a24.533333 24.533333 0 0 1-18.133334-41.216l0.725334-0.768z m249.386666-229.248a29.013333 29.013333 0 0 0-10.325333 21.76 29.013333 29.013333 0 0 0 10.325333 21.76c7.168 6.186667 15.402667 13.056 24.149334 20.352 28.288 23.552 63.488 52.864 91.562666 84.394667a28.757333 28.757333 0 0 1-2.432 40.704 29.098667 29.098667 0 0 1-40.96-2.432c-25.173333-28.330667-57.173333-54.954667-85.376-78.421334-8.96-7.466667-17.408-14.506667-25.002666-21.077333-19.2-16.64-30.250667-40.448-30.250667-65.28 0-24.874667 11.008-48.64 30.293333-65.28 7.253333-6.314667 15.36-13.098667 23.893334-20.224 46.933333-39.296 125.568-105.045333 125.568-152.448V235.861333a28.970667 28.970667 0 0 0-29.013334-28.842666H300.288a28.970667 28.970667 0 0 0-29.013333 28.842666v44.714667c0 47.402667 78.634667 113.152 125.610666 152.448 8.533333 7.125333 16.64 13.909333 23.893334 20.181333 19.242667 16.64 30.293333 40.448 30.293333 65.28 0 24.874667-11.050667 48.682667-30.293333 65.322667-7.253333 6.314667-15.36 13.056-23.893334 20.224-46.933333 39.253333-125.568 105.002667-125.568 152.448v44.714667c0 15.872 13.013333 28.842667 29.013334 28.842666h391.338666c16 0 29.013333-12.970667 29.013334-28.842666 0-15.957333 12.970667-28.842667 29.013333-28.842667 15.957333 0 28.970667 12.885333 28.970667 28.842667a86.869333 86.869333 0 0 1-86.997334 86.528H300.288A86.869333 86.869333 0 0 1 213.333333 801.194667V756.48c0-74.325333 84.48-144.981333 146.218667-196.608 8.362667-6.997333 16.298667-13.610667 23.210667-19.584a29.013333 29.013333 0 0 0 10.325333-21.76 29.013333 29.013333 0 0 0-10.325333-21.76c-6.912-5.973333-14.848-12.629333-23.210667-19.626667C297.856 425.514667 213.333333 354.858667 213.333333 280.576V235.861333C213.333333 188.16 252.330667 149.333333 300.288 149.333333h391.381333c47.957333 0 86.997333 38.826667 86.997334 86.528v44.714667c0 74.282667-84.522667 144.981333-146.261334 196.565333-8.362667 6.997333-16.256 13.653333-23.168 19.626667z m-81.92-80.298667c-17.194667 14.933333-42.538667 14.933333-59.733333 0-0.554667-0.426667-20.778667-17.749333-43.818667-38.016-18.048-15.914667-6.954667-45.952 16.981334-45.952h113.365333c23.936 0 35.072 30.037333 17.024 45.952-23.04 20.266667-43.306667 37.546667-43.818667 37.973334z"  /></svg>
                            </div>
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-13 text-primary fw-600">{{ translate('In progress') }}</span>
                                </p>
                                <h3 class="mb-0" style="color: #A9A3CC">
                                    {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'in_progress')->count() }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('seller.orders.index', ['delivery_status' => 'picked_up']) }}" class="order_status">
                        <div class="row align-items-center mb-4">
                            <div class="col-auto text-left">
                                <svg class="svg-icon" fill="#2E294E" width="30" height="30" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M832.568046 246.388395l-101.669704 0 0 50.578372-47.481423 0 0-50.578372-102.302909 0c-36.963824 0-66.932971 30.090671-66.932971 67.188811l0 157.634795 116.195043 109.06605c7.593344 7.141785 13.491745 15.538468 18.135248 24.533817L832.568046 604.811869c36.976616 0 66.945763-30.079158 66.945763-67.188811L899.513808 313.578485C899.513808 276.480345 869.544662 246.388395 832.568046 246.388395L832.568046 246.388395zM736.43217 441.194245l0 98.731376-59.426613 0 0-98.731376L635.008074 441.194245l71.979423-85.483959 71.699278 85.799922C778.698287 441.511487 778.283825 441.194245 736.43217 441.194245L736.43217 441.194245zM125.764115 138.871459C125.764115 62.527399 187.421656 0.639601 263.483012 0.639601c76.05624 0 137.718898 61.887797 137.718898 138.231858 0 76.329989-61.662658 138.217787-137.718898 138.217787C187.421656 277.089246 125.764115 215.200169 125.764115 138.871459L125.764115 138.871459zM601.784637 676.987009c-8.835449 9.494238-20.815177 14.295083-32.807696 14.295083-10.993463 0-22.035535-4.033324-30.688058-12.162654L353.359752 505.531715l0 128.809255c0 28.397007-13.345915 53.430992-33.790123 69.968517l100.290724 263.91986c5.862583 24.217854-8.932668 48.616076-33.052024 54.491451-3.565136 0.889045-7.141785 1.279202-10.651916 1.279202-20.249769 0-38.628066-13.808987-43.631025-34.442516l-57.58712-112.746314-32.431611 102.680273c-3.534435 24.643828-26.318304 41.803045-50.852121 38.255818-24.576031-3.521643-41.639307-26.360518-38.122781-51.02993l58.249747-258.777468c-23.034592-16.331573-38.171391-43.144928-38.171391-73.600172L173.610111 421.376846c0-49.809571 40.237302-90.200378 89.876739-90.200378 11.485956 0 22.377082 2.365245 32.473824 6.30135 7.909307 1.596444 15.520559 5.203794 21.846213 11.139292l281.878578 264.604233C617.798968 630.259036 618.749415 658.801872 601.784637 676.987009L601.784637 676.987009z"  /></svg>        
                            </div>
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-13 text-primary fw-600">{{ translate('Picked up') }}</span>
                                </p>
                                <h3 class="mb-0" style="color: #A9A3CC">
                                    {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'picked_up')->count() }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('seller.orders.index', ['delivery_status' => 'on_the_way']) }}" class="order_status">
                        <div class="row align-items-center mb-4">
                            <div class="col-auto text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
                            ...
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-13 text-primary fw-600">{{ translate('On the way') }}</span>
                                </p>
                                <h3 class="mb-0" style="color: #A9A3CC">
                    ...
                    <a href="{{ route('seller.orders.index', ['delivery_status' => 'delivered']) }}" class="order_status">
                        <div class="row align-items-center mb-4">
                            <div class="col-auto text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
                                    <g id="Group_23747" data-name="Group 23747" transform="translate(1894 3457)">
                                        ...
                                        <g id="Group_23746" data-name="Group 23746" transform="translate(-1599.983 686.845)">
                                            <path id="Path_26918" data-name="Path 26918"
                                                ...
                                                transform="translate(-2351 -4226)" fill="#28a745" />
                                            <path id="Path_26919" data-name="Path 26919"
                                                ...
                                                transform="translate(-2557.593 -4432.681)" fill="#28a745" />
                                            <path id="Path_26920" data-name="Path 26920"
                                                ...
                                                transform="translate(-2626.31 -4518.65)" fill="#28a745" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-13 fw-600" style="color: #28a745">{{ translate('Delivered') }}</span>
                                </p>
                    ...
                    <a href="{{ route('seller.orders.index', ['delivery_status' => 'cancelled']) }}" class="order_status">
                        <div class="row align-items-center mb-4">
                            <div class="col-auto text-left">
                                    ...
                                    <g id="Group_23751" data-name="Group 23751" transform="translate(0 0.001)">
                                        <g id="Group_23750" data-name="Group 23750" transform="translate(0 -0.001)"
                                            ...
                                            <path id="Path_27505" data-name="Path 27505"
                                                ...
                                                transform="translate(0 0)" fill="#dc3545" />
                                            <path id="Path_27506" data-name="Path 27506"
                                                ...
                                                transform="translate(-174.22 -84.719)" fill="#dc3545" />
                                            <path id="Path_27507" data-name="Path 27507"
                                                ...
                                                transform="translate(-227.869 -227.867)" fill="#dc3545" />
                                            <path id="Path_27508" data-name="Path 27508"
                                                ...
                                                transform="translate(-307.867 -307.756)" fill="#dc3545" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-13 fw-600" style="color: #dc3545">{{ translate('Cancelled') }}</span>
                                </p>
